export const post = {
  ...
  description: "Discover the most iconic shopping streets of Naples, from the historic Via Toledo to the elegant Via Chiaia",
  author: "Local Expert",
  ...
  callToAction: {
    position: 2,
    text: "Save these shopping destinations and discover more hidden gems in Naples with Locator",
