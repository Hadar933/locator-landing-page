export const post = {
  ...
  description: "A personal guide to the best spots in Krabi and Ao Nang - from luxury resorts to hidden gems. Discover amazing restaurants, breathtaking viewpoints, and unforgettable beaches in this Thai paradise.",
