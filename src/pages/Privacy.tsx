        ...
        <div className="max-w-3xl mx-auto">
          ...
          <article className="prose prose-gray max-w-none">
            ...
            <ul>
              ...
              <li><strong>Application</strong> refers to Locator, the software program provided by the Company.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Locator.</li>
            ...
            <p>By email: locatorapp.ai@gmail.com</p>
          </article>
        </div>
      </div>
      <Footer />
