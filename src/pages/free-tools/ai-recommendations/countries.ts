export const COUNTRIES_WITH_FLAGS: Record<string, string> = {
  ...
  'Burkina Faso': '🇧🇫', 'Bangladesh': '🇧🇩', 'Bulgaria': '🇧🇬', 'Bahrain': '🇧ḧ', 'Bahamas': '🇧🇸',
  'Bosnia and Herzegovina': '🇧🇦', 'Saint Barthélemy': '🇧🇱', 'Belarus': '🇧🇾', 'Belize': '🇧🇿',
  'Bermuda': '🇧🇲', 'Bolivia, Plurinational State of': '🇧🇴', 'Brazil': '🇧🇷', 'Barbados': '🇧🇧',
  ...
  'Guinea': '🇬🇳', 'Guadeloupe': '🇬🇵', 'Gambia': '🇬🇲', 'Guinea-Bissau': '🇬🇼', 
  ...
  'British Indian Ocean Territory': '🇮🇴', 'Ireland': '🇮🇪', 'Iran, Islamic Republic of': '🇮🇷', 
  'Iraq': '🇮🇶', 'Iceland': '🇮🇸', 'Israel': '🇮🇱', 'Italy': '🇮🇹', 'Jamaica': '🇯🇲', 'Jersey': '🇯🇪', 
  'Jordan': '🇯🇴', 'Japan': '🇯🇵', 'Kazakhstan': '🇰🇿', 'Kenya': '🇰🇪', 'Kyrgyzstan': '🇰🇬', 
  'Cambodia': '🇰🇭', 'Kiribati': '🇰🇮', 'Saint Kitts and Nevis': '🇰🇳', 'Korea, Republic of': '🇰🇷', 
  ...
  'Mayotte': '🇾🇹', 'Namibia': '🇳🇦', 'New Caledonia': '🇳🇨', 'Niger': '🇳🇪', 'Norfolk Island': '🇳🇫', 
  'Nigeria': '🇳🇬', 'Nicaragua': '🇳🇮', 'Niue': '🇳🇺', 'Netherlands': '🇳🇱', 'Norway': '🇳🇴', 
  'Nepal': '🇳🇵', 'Nauru': '🇳🇷', 'New Zealand': '🇳🇿', 'Oman': '🇴🇲', 'Pakistan': '🇵🇰', 
  'Panama': '🇵🇦', 'Pitcairn': '🇵🇳', 'Peru': '🇵🇪', 'Philippines': '🇵🇭', 'Palau': '🇵🇼', 
  'Papua New Guinea': '🇵🇬', 'Poland': '🇵🇱', 'Puerto Rico': '🇵🇷', 'Portugal': '🇵🇹', 'Paraguay': '🇵🇾', 
  'French Polynesia': '🇵🇫', 'Qatar': '🇶🇦', 'Réunion': '🇷🇪', 'Romania': '🇷🇴', 'Russian Federation': '🇷🇺', 
  ...
  'Syrian Arab Republic': '🇸🇾', 'Turks and Caicos Islands': '🇹🇨', 'Chad': '🇹🇩', 'Togo': '🇹🇬', 'Thailand': '🇹🇭', 
  'Tajikistan': '🇹🇯', 'Tokelau': '🇹🇰', 'Turkmenistan': '🇹🇲', 'Timor-Leste': '🇹🇱', 'Tonga': '🇹🇴', 
  'Trinidad and Tobago': '🇹🇹', 'Tunisia': '🇹🇳', 'Türkiye': '🇹🇷', 'Tuvalu': '🇹🇻', 
  'Taiwan': '🇹🇼', 'Tanzania, United Republic of': '🇹🇿', 'Uganda': '🇺🇬', 'Ukraine': '🇺🇦',
